...
async function listFileSnapshots() {
  ...
  try {
    ...
    return jsons.slice(0, 50).map((fn) => {
      ...
      return { id: "file:" + fn, name: name.slice(0, 40), at: "", version: APP_VERSION };
    });
  } catch {
    return [];
  }
...
const THEME_CATEGORIES = [
  ...
  { key: "gold", title: "Royal Gold • Desert" },
  { key: "neon", title: "Neon Marina • Cyber" },
  { key: "noir", title: "Noir Executive • Black" },
  { key: "minimal", title: "Minimal Luxe • Clean" },
];
...
const THEME_PRESETS = {
  ...
  dxbSkylineSignature: {
    ...
    cat: "signature",
    name: "Royal Skyline Gold",
    skyline: "https://images.unsplash.com/photo-1512453979798-5ea266f8880c?auto=format&fit=crop&w=1800&q=70",
    ...
    neon: "rgba(255,209,112,0.66)",
    neon2: "rgba(76,190,255,0.42)",
    gold: "#ffd170",
    green: "#7bffb2",
    orange: "#ffb35c",
    red: "#ff6b6b",
  ...
  dxbSkylineMidnight: {
    ...
    cat: "signature",
    name: "Midnight Marina Noir",
    skyline: "https://images.unsplash.com/photo-1526481280695-3c687fd643ed?auto=format&fit=crop&w=1800&q=70",
    overlay: "rgba(2,5,12,0.78)",
  ...
  platinumHorizon: {
    ...
    skyline: "https://images.unsplash.com/photo-1504270997636-07ddfbd48945?auto=format&fit=crop&w=1800&q=70",
    ...
    text: "rgba(255,255,255,0.98)",
    sub: "rgba(255,255,255,0.74)",
    neon: "rgba(210,230,255,0.52)",
    neon2: "rgba(255,209,112,0.24)",
    gold: "#ffd170",
    green: "#7bffb2",
    orange: "#ffb35c",
    red: "#ff5d73",
    ...
    hud: "rgba(210,230,255,0.12)",
    orb: "rgba(210,230,255,0.16)",
  ...
  desertGoldElite: {
    key: "desertGoldElite",
    cat: "gold",
    name: "Desert Gold Royale",
    skyline: "https://images.unsplash.com/photo-1509316785289-025f5b846b35?auto=format&fit=crop&w=1800&q=70",
    overlay: "rgba(14,9,6,0.70)",
    glass: "rgba(255,255,255,0.12)",
    glass2: "rgba(255,255,255,0.08)",
    stroke: "rgba(255,255,255,0.18)",
    ...
    orb2: "rgba(255,140,90,0.14)",
  },
  desertRoseGold: {
    key: "desertRoseGold",
    cat: "gold",
    name: "Rose Gold Mirage",
    skyline: "https://images.unsplash.com/photo-1518684079-3c830dcef090?auto=format&fit=crop&w=1800&q=70",
    overlay: "rgba(16,7,10,0.72)",
    glass: "rgba(255,255,255,0.12)",
    glass2: "rgba(255,255,255,0.08)",
    stroke: "rgba(255,255,255,0.18)",
    text: "rgba(255,255,255,0.97)",
    sub: "rgba(255,255,255,0.76)",
    neon: "rgba(255,160,190,0.58)",
    neon2: "rgba(255,209,112,0.32)",
    gold: "#ffd170",
    green: "#7bffb2",
    orange: "#ffb35c",
    red: "#ff5d73",
  ...
  palmSunset: {
    ...
    name: "Palm Sunset",
    skyline: "https://images.unsplash.com/photo-1504270997636-07ddfbd48945?auto=format&fit=crop&w=1800&q=70",
    overlay: "rgba(16,8,6,0.68)",
    glass: "rgba(255,255,255,0.12)",
    glass2: "rgba(255,255,255,0.08)",
    stroke: "rgba(255,255,255,0.18)",
    text: "rgba(255,255,255,0.97)",
    sub: "rgba(255,255,255,0.76)",
    neon: "rgba(255,190,120,0.60)",
    neon2: "rgba(255,107,220,0.30)",
    gold: "#ffd170",
    green: "#7bffb2",
    orange: "#ffb35c",
    red: "#ff6b6b",
    haze: "rgba(255,255,255,0.09)",
    star: "rgba(255,255,255,0.20)",
    hud: "rgba(255,190,120,0.14)",
    orb: "rgba(255,190,120,0.18)",
    orb2: "rgba(255,107,220,0.12)",
  },
  ...
  marinaNeonWave: {
    ...
    text: "rgba(255,255,255,0.97)",
    sub: "rgba(255,255,255,0.74)",
    neon: "rgba(76,190,255,0.66)",
    neon2: "rgba(255,107,220,0.42)",
    gold: "#ffd170",
    green: "#6dffc0",
    orange: "#ffb35c",
    red: "#ff5d73",
  ...
  cyberAquaPulse: {
    ...
    skyline: "https://images.unsplash.com/photo-1496307653780-42ee777d4833?auto=format&fit=crop&w=1800&q=70",
    ...
    neon: "rgba(77,255,245,0.58)",
    neon2: "rgba(76,190,255,0.32)",
    gold: "#ffd170",
    green: "#6dffc0",
    orange: "#ffb35c",
    red: "#ff5d73",
  ...
  noirLuxe: {
    key: "noirLuxe",
    cat: "noir",
    name: "Noir Luxe Executive",
    skyline: "https://images.unsplash.com/photo-1528909514045-2fa4ac7a08ba?auto=format&fit=crop&w=1800&q=70",
  ...
  minimalPearl: {
    ...
    sub: "rgba(255,255,255,0.70)",
    neon: "rgba(255,209,112,0.40)",
    neon2: "rgba(76,190,255,0.20)",
    gold: "#ffd170",
    green: "#7bffb2",
    orange: "#ffb35c",
    red: "#ff5d73",
...
const [tab, setTab] = useState("home");
  ...
  const sheenX = sheenAnim.interpolate({ inputRange: [0, 1], outputRange: [-320, 540] });
  ...
  useEffect(() => {
    ...
    const f = Animated.loop(
      Animated.sequence([
        Animated.delay(5200),
        Animated.timing(sheenAnim, { toValue: 1, duration: 2600, easing: Easing.inOut(Easing.quad), useNativeDriver: true }),
        Animated.timing(sheenAnim, { toValue: 0, duration: 0, useNativeDriver: true }),
      ])
    );
    ...
    a.start(); b.start(); c.start(); d.start(); e.start(); f.start(); shine.start();
    return () => { a.stop(); b.stop(); c.stop(); d.stop(); e.stop(); f.stop(); shine.stop(); };
  }, []);
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: "#000" }}>
      ...
      <ImageBackground source={{ uri: theme.skyline }} style={{ flex: 1 }} resizeMode="cover">
        <View style={{ flex: 1, backgroundColor: theme.overlay }}>
          ...
          <LuxSheen theme={theme} sheenX={sheenX} />
    ...
    <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 18 }}>
      ...
      <GlassCard theme={theme} style={{ padding: 14, marginTop: 12 }}>
        <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "center" }}>
          ...
          <Text style={{ color: "rgba(255,255,255,0.55)", fontWeight: "900", fontSize: 12 }}>{Object.keys(THEME_PRESETS).length}</Text>
        </View>
...
function LuxSheen({ theme, sheenX }) {
  // Premium diagonal sheen sweep (subtle, looped)
  return (
    <Animated.View
      pointerEvents="none"
      style={{
