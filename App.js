// App.js — Dubai Journey PRO v6 (Final • Ultra Premium Themes) (Single-file • No external dependencies)
...
const THEME_CATEGORIES = [
  { key: "ultra", title: "Ultra Premium • Signature" },
  { key: "signature", title: "Signature • Skyline" },
  { key: "gold", title: "Aurum • Desert Gold" },
...
const THEME_PRESETS = {
  // ✅ v6 Ultra Premium Pack (more FX + richer glass)
  burjRoyaleUltra: {
    key: "burjRoyaleUltra",
    cat: "ultra",
    name: "Burj Royale Ultra (Default)",
    skyline:
      "https://images.unsplash.com/photo-1512453979798-5ea266f8880c?auto=format&fit=crop&w=2000&q=70",
    ...
    neon: "rgba(255,209,112,0.74)",
    neonMid: "rgba(255,209,112,0.46)",
    neon2: "rgba(96,210,255,0.46)",
    gold: "#ffd170",
    green: "#7bffb2",
    orange: "#ffb35c",
    red: "#ff6b6b",
    ...
    hud: "rgba(255,209,112,0.18)",
    orb: "rgba(255,209,112,0.22)",
    orb2: "rgba(96,210,255,0.18)",
    fx: { stripesOpacity: 0.78, scanOpacity: 0.26, orbOpacity1: 0.62, orbOpacity2: 0.52, hazeMax: 0.26, beam: true, beamOpacity: 0.16 },
  },
  penthouseAurum: {
    key: "penthouseAurum",
    cat: "ultra",
    name: "Penthouse Aurum",
    skyline:
      "https://images.unsplash.com/photo-1526481280695-3c687fd643ed?auto=format&fit=crop&w=2000&q=70",
    overlay: "rgba(5,8,16,0.80)",
    glass: "rgba(255,255,255,0.15)",
    glass2: "rgba(255,255,255,0.10)",
    stroke: "rgba(255,255,255,0.28)",
    text: "rgba(255,255,255,0.98)",
    sub: "rgba(255,255,255,0.78)",
    neon: "rgba(255,209,112,0.70)",
    neonMid: "rgba(255,209,112,0.44)",
    neon2: "rgba(170,120,255,0.36)",
    gold: "#ffd170",
    green: "#7bffb2",
    orange: "#ffb35c",
    red: "#ff6b6b",
    haze: "rgba(255,255,255,0.11)",
    star: "rgba(255,255,255,0.28)",
    hud: "rgba(255,209,112,0.16)",
    orb: "rgba(255,209,112,0.20)",
    orb2: "rgba(170,120,255,0.16)",
    fx: { stripesOpacity: 0.76, scanOpacity: 0.24, orbOpacity1: 0.58, orbOpacity2: 0.48, hazeMax: 0.24, beam: true, beamOpacity: 0.14 },
  },
  obsidianMirage: {
    key: "obsidianMirage",
    cat: "ultra",
    ...
    skyline:
      "https://images.unsplash.com/photo-1504270997636-07ddfbd48945?auto=format&fit=crop&w=2000&q=70",
    overlay: "rgba(2,3,8,0.84)",
    glass: "rgba(255,255,255,0.12)",
    glass2: "rgba(255,255,255,0.08)",
    stroke: "rgba(255,255,255,0.22)",
    text: "rgba(255,255,255,0.98)",
    sub: "rgba(255,255,255,0.76)",
    neon: "rgba(140,210,255,0.52)",
    neonMid: "rgba(140,210,255,0.30)",
    neon2: "rgba(255,209,112,0.34)",
    gold: "#ffd170",
    green: "#7bffb2",
    orange: "#ffb35c",
    red: "#ff6b6b",
    haze: "rgba(255,255,255,0.10)",
    star: "rgba(255,255,255,0.26)",
    hud: "rgba(140,210,255,0.14)",
    orb: "rgba(140,210,255,0.18)",
    orb2: "rgba(255,209,112,0.14)",
    fx: { stripesOpacity: 0.72, scanOpacity: 0.22, orbOpacity1: 0.54, orbOpacity2: 0.46, hazeMax: 0.22, beam: true, beamOpacity: 0.12 },
  },
  dxbSkylineSignature: {
    key: "dxbSkylineSignature",
    cat: "signature",
    name: "Skyline Signature • Pro",
    skyline:
...
const [tab, setTab] = useState("home");
  ...
  const theme = useMemo(() => THEME_PRESETS[S.themeKey] || THEME_PRESETS.burjRoyaleUltra, [S.themeKey]);
  ...
  const beamX = beamAnim.interpolate({ inputRange: [0, 1], outputRange: [-420, 520] });
  const beamO = beamAnim.interpolate({ inputRange: [0, 0.25, 0.75, 1], outputRange: [0, (theme.fx?.beamOpacity ?? 0.14), (theme.fx?.beamOpacity ?? 0.14), 0] });
  const hazeScale = hazeAnim.interpolate({ inputRange: [0, 1], outputRange: [1, 1.16] });
  const hazeOpacity = hazeAnim.interpolate({ inputRange: [0, 1], outputRange: [0.06, (theme.fx?.hazeMax ?? 0.20)] });
  ...
  useEffect(() => {
    ...
    // Ultra beam sweep (shown only on Ultra themes)
    const f = Animated.loop(
      Animated.sequence([
        Animated.delay(5200),
        Animated.timing(beamAnim, { toValue: 1, duration: 1650, easing: Easing.out(Easing.quad), useNativeDriver: true }),
        Animated.timing(beamAnim, { toValue: 0, duration: 0, useNativeDriver: true }),
      ])
    );


    a.start(); b.start(); c.start(); d.start(); e.start(); shine.start(); f.start();
        ...
        <View style={{ flex: 1, backgroundColor: theme.overlay }}>
          ...
          {theme.fx?.beam && (
            <Animated.View
              ...
              style={{
                ...
                transform: [{ translateX: beamX }, { rotate: "14deg" }],
                opacity: beamO,
              }}
            />
          )}
          ...
          <Animated.View
            ...
            style={{
              ...
              opacity: theme.fx?.orbOpacity1 ?? 0.52,
              top: 0,
              left: 0,
            }}
          />
          <Animated.View
            ...
            style={{
              ...
              opacity: theme.fx?.orbOpacity2 ?? 0.48,
              top: 0,
              left: 0,
            }}
          />
...
function NeonStripes({ theme, moveStripe }) {
  return (
    <View pointerEvents="none" style={{ position: "absolute", left: 0, right: 0, top: 0, bottom: 0, opacity: theme.fx?.stripesOpacity ?? 0.62 }}>
      ...
      <Animated.View style={{ position: "absolute", top: 220, left: -270, width: 760, height: 1, backgroundColor: (theme.neonMid || "rgba(255,209,112,0.35)"), transform: [{ translateX: moveStripe }, { rotate: "10deg" }] }} />
...
function Scanline({ theme, scanY }) {
  return (
    <Animated.View pointerEvents="none" style={{ position: "absolute", left: 0, right: 0, height: 90, transform: [{ translateY: scanY }], opacity: theme.fx?.scanOpacity ?? 0.20 }}>
