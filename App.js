...
const THEME_CATEGORIES = [
  { key: "ultra", title: "✦ Ultra Premium • v6 Exclusive" },
...
const THEME_PRESETS = {
  // ══════════════════════════════════════════════
  //   ULTRA PREMIUM v6 EXCLUSIVE THEMES
  // ══════════════════════════════════════════════
  ultraBlackDiamond: {
    key: "ultraBlackDiamond",
    cat: "ultra",
    name: "Black Diamond ◆",
    skyline:
      "https://images.unsplash.com/photo-1512453979798-5ea266f8880c?auto=format&fit=crop&w=1800&q=80",
    overlay: "rgba(0,0,2,0.85)",
    glass: "rgba(255,255,255,0.09)",
    glass2: "rgba(255,255,255,0.05)",
    stroke: "rgba(200,220,255,0.22)",
    text: "rgba(255,255,255,0.98)",
    sub: "rgba(200,215,255,0.75)",
    neon: "rgba(140,180,255,0.72)",
    neon2: "rgba(255,209,112,0.42)",
    gold: "#e8ccff",
    green: "#a0ffdc",
    orange: "#ffb35c",
    red: "#ff5d73",
    haze: "rgba(120,140,255,0.08)",
    star: "rgba(200,220,255,0.28)",
    hud: "rgba(140,180,255,0.14)",
    orb: "rgba(100,130,255,0.22)",
  ...
  ultraSolarFlare: {
    ...
    overlay: "rgba(8,4,0,0.82)",
    glass: "rgba(255,140,40,0.10)",
    glass2: "rgba(255,120,20,0.06)",
    stroke: "rgba(255,160,60,0.28)",
    text: "rgba(255,255,240,0.98)",
    sub: "rgba(255,220,160,0.80)",
    neon: "rgba(255,140,30,0.80)",
    neon2: "rgba(255,60,80,0.45)",
    gold: "#ffcc44",
    green: "#7bffb2",
    orange: "#ff8c22",
    red: "#ff4060",
    haze: "rgba(255,120,20,0.10)",
    star: "rgba(255,200,100,0.30)",
    hud: "rgba(255,140,30,0.16)",
    orb: "rgba(255,120,20,0.26)",
    orb2: "rgba(255,60,80,0.14)",
  },
  ultraAuroraElite: {
    key: "ultraAuroraElite",
    cat: "ultra",
    name: "Aurora Elite ✦",
    skyline:
      "https://images.unsplash.com/photo-1526481280695-3c687fd643ed?auto=format&fit=crop&w=1800&q=80",
    overlay: "rgba(0,4,12,0.84)",
    glass: "rgba(0,255,180,0.08)",
    glass2: "rgba(0,200,140,0.05)",
    stroke: "rgba(0,255,200,0.22)",
    text: "rgba(220,255,245,0.98)",
    sub: "rgba(160,255,220,0.78)",
    neon: "rgba(0,255,200,0.70)",
    neon2: "rgba(120,60,255,0.48)",
    gold: "#7bffdb",
    green: "#00ffcc",
    orange: "#ffb35c",
    red: "#ff5d73",
    haze: "rgba(0,200,140,0.08)",
    star: "rgba(0,255,200,0.28)",
    hud: "rgba(0,255,200,0.14)",
    orb: "rgba(0,200,160,0.22)",
    orb2: "rgba(120,60,255,0.14)",
  },
  ultraRoyalCrimson: {
    key: "ultraRoyalCrimson",
    cat: "ultra",
    name: "Royal Crimson ♛",
    skyline:
      "https://images.unsplash.com/photo-1509316785289-025f5b846b35?auto=format&fit=crop&w=1800&q=80",
    overlay: "rgba(6,0,2,0.86)",
    glass: "rgba(200,0,60,0.10)",
    glass2: "rgba(180,0,50,0.06)",
    stroke: "rgba(220,60,100,0.26)",
    text: "rgba(255,240,244,0.98)",
    sub: "rgba(255,180,200,0.78)",
    neon: "rgba(220,40,80,0.78)",
    neon2: "rgba(255,209,112,0.40)",
    gold: "#ffaac8",
    green: "#7bffb2",
    orange: "#ffb35c",
    red: "#ff3355",
    haze: "rgba(180,0,50,0.10)",
    star: "rgba(255,100,140,0.28)",
    hud: "rgba(220,40,80,0.14)",
    orb: "rgba(200,0,60,0.24)",
    orb2: "rgba(255,209,112,0.12)",
  },
  dxbSkylineSignature: {
...
function DubaiIntro({ onDone, durationMs = 4500 }) {
  ...
  const starFloat = React.useRef(new Animated.Value(0)).current;
  const ringScale = React.useRef(new Animated.Value(0.7)).current;
  ...
  const neonBrightness = React.useRef(new Animated.Value(0)).current;
  const particle1Y = React.useRef(new Animated.Value(H * 0.85)).current;
  const particle2Y = React.useRef(new Animated.Value(H * 0.75)).current;
  const particle3Y = React.useRef(new Animated.Value(H * 0.90)).current;
  const scanlineY = React.useRef(new Animated.Value(-40)).current;
  ...
  React.useEffect(() => {
    ...
    Animated.loop(
      Animated.sequence([
        Animated.timing(starFloat, { toValue: -12, duration: 2200, easing: Easing.inOut(Easing.sin), useNativeDriver: true }),
        Animated.timing(starFloat, { toValue: 0, duration: 2200, easing: Easing.inOut(Easing.sin), useNativeDriver: true }),
      ])
    ).start();

    // Expanding ring entrance
    Animated.parallel([
      Animated.timing(ringScale, { toValue: 1, duration: 1200, easing: Easing.out(Easing.cubic), useNativeDriver: true }),
    ...
    // Neon brightness ramp
    Animated.timing(neonBrightness, { toValue: 1, duration: 1600, easing: Easing.out(Easing.quad), useNativeDriver: true }).start();

    // Rising particles
    Animated.loop(
      Animated.parallel([
        Animated.timing(particle1Y, { toValue: -60, duration: 4200, easing: Easing.linear, useNativeDriver: true }),
        Animated.timing(particle2Y, { toValue: -60, duration: 3600, easing: Easing.linear, useNativeDriver: true }),
        Animated.timing(particle3Y, { toValue: -60, duration: 5000, easing: Easing.linear, useNativeDriver: true }),
      ])
    ).start();
    ...
    Animated.loop(
      Animated.sequence([
        Animated.timing(scanlineY, { toValue: H + 40, duration: 3000, easing: Easing.linear, useNativeDriver: true }),
        Animated.timing(scanlineY, { toValue: -40, duration: 0, useNativeDriver: true }),
      ])
    ).start();

    const t = setTimeout(() => onDone?.(), Math.max(1200, durationMs));
    return () => clearTimeout(t);
  }, [W, H, durationMs, onDone, shimmerX, pulse, starFloat, ringScale, ringOpacity, cardScale, cardOpacity, neonBrightness, particle1Y, particle2Y, particle3Y, scanlineY]);
  ...
  const neonGlow = neonBrightness.interpolate({ inputRange: [0, 1], outputRange: [0, 0.7] });
  ...
  return (
    <Pressable onPress={() => onDone?.()} style={{ flex: 1, backgroundColor: "#05070B" }}>
      ...
      {/* Rising particles */}
      <Animated.View pointerEvents="none" style={{ position: "absolute", left: W * 0.18, width: 3, height: 3, borderRadius: 2, backgroundColor: "rgba(255,209,112,0.70)", transform: [{ translateY: particle1Y }] }} />
      <Animated.View pointerEvents="none" style={{ position: "absolute", left: W * 0.55, width: 2, height: 2, borderRadius: 1, backgroundColor: "rgba(76,190,255,0.70)", transform: [{ translateY: particle2Y }] }} />
      <Animated.View pointerEvents="none" style={{ position: "absolute", left: W * 0.78, width: 4, height: 4, borderRadius: 2, backgroundColor: "rgba(255,255,255,0.40)", transform: [{ translateY: particle3Y }] }} />

      {/* Outer ring / halo around card */}
      <View style={{ position: "absolute", left: 0, right: 0, top: 0, bottom: 0, alignItems: "center", justifyContent: "center" }}>
        <Animated.View
          style={{
            width: Math.min(310, W * 0.88),
            height: Math.min(310, W * 0.88),
            borderRadius: Math.min(310, W * 0.88),
            borderWidth: 1,
            borderColor: "rgba(255,209,112,0.14)",
            opacity: ringOpacity,
        ...
        <Animated.View
          style={{
            position: "absolute",
            width: Math.min(280, W * 0.80),
            height: Math.min(280, W * 0.80),
            borderRadius: Math.min(280, W * 0.80),
            borderWidth: 1,
            borderColor: "rgba(76,190,255,0.10)",
            opacity: ringOpacity,
            transform: [{ scale: ringScale }],
          }}
        />
      ...
      <View style={{ flex: 1, alignItems: "center", justifyContent: "center", paddingHorizontal: 18 }}>
        <Animated.View
          style={{
            ...
            transform: [{ scale: cardScale }, { translateY: starFloat }],
            opacity: cardOpacity,
            shadowColor: "#ffd170",
            shadowOpacity: 0.25,
            shadowRadius: 32,
        ...
        >
          ...
          <Text style={{ color: "rgba(255,255,255,0.70)", fontSize: 13, textAlign: "center", marginTop: 8 }}>
            Ultra Premium • Neon Skyline • v6 Final
          </Text>
    ...
    <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 18 }}>
      ...
      <GlassCard theme={theme} style={{ padding: 14, marginTop: 12 }}>
        <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "center" }}>
          ...
          <Text style={{ color: "rgba(255,255,255,0.55)", fontWeight: "900", fontSize: 12 }}>14</Text>
        </View>
