...
/* =========================
   Themes (Ultra) — Reduced & fully redesigned (non‑Dubai)
========================= */
const THEME_CATEGORIES = [
  { key: "cosmic", title: "Cosmic" },
...
const THEME_PRESETS = {
  nebulaPrime: {
    ...
    name: "Nebula Prime",
    skyline:
      "https://images.unsplash.com/photo-1444703686981-a3abbc4d4fe3?auto=format&fit=crop&w=1800&q=70",
    overlay: "rgba(6,7,18,0.78)",
    glass: "rgba(255,255,255,0.11)",
    glass2: "rgba(255,255,255,0.07)",
    stroke: "rgba(255,255,255,0.18)",
    text: "rgba(255,255,255,0.98)",
    sub: "rgba(255,255,255,0.76)",
    neon: "rgba(150,120,255,0.60)",
    neon2: "rgba(90,210,255,0.38)",
    gold: "#d7c6ff",
    green: "#79ffd7",
    orange: "#ffb35c",
    red: "#ff5d73",
    ...
    hud: "rgba(150,120,255,0.14)",
    orb: "rgba(150,120,255,0.20)",
    orb2: "rgba(90,210,255,0.14)",
  },
  ...
  auroraMint: {
    ...
    name: "Aurora Mint",
    skyline:
      "https://images.unsplash.com/photo-1451188502541-13943edb6acb?auto=format&fit=crop&w=1800&q=70",
    overlay: "rgba(3,10,14,0.76)",
    glass: "rgba(255,255,255,0.10)",
    glass2: "rgba(255,255,255,0.07)",
    stroke: "rgba(255,255,255,0.18)",
    text: "rgba(255,255,255,0.98)",
    sub: "rgba(255,255,255,0.74)",
    neon: "rgba(110,255,214,0.58)",
    neon2: "rgba(120,170,255,0.36)",
    gold: "#b9fff0",
    green: "#6dffc0",
    orange: "#ffb35c",
    red: "#ff6b6b",
    haze: "rgba(255,255,255,0.08)",
    star: "rgba(255,255,255,0.22)",
    hud: "rgba(110,255,214,0.12)",
    orb: "rgba(110,255,214,0.18)",
    orb2: "rgba(120,170,255,0.12)",
  },
  ...
  carbonNoir: {
    ...
    neon: "rgba(255,255,255,0.30)",
    neon2: "rgba(255,255,255,0.18)",
    gold: "#e8e8e8",
    green: "#7bffb2",
    orange: "#ffb35c",
    red: "#ff5d73",
    ...
    hud: "rgba(255,255,255,0.10)",
    orb: "rgba(255,255,255,0.10)",
  ...
  paperMono: {
    ...
    name: "Paper Mono",
    skyline:
      "https://images.unsplash.com/photo-1526406915894-7bcd65f60845?auto=format&fit=crop&w=1800&q=70",
    overlay: "rgba(18,18,22,0.66)",
    glass: "rgba(255,255,255,0.12)",
    glass2: "rgba(255,255,255,0.08)",
    stroke: "rgba(255,255,255,0.20)",
    text: "rgba(255,255,255,0.98)",
    sub: "rgba(255,255,255,0.78)",
    neon: "rgba(255,255,255,0.34)",
    neon2: "rgba(180,180,180,0.22)",
    gold: "#f2f2f2",
    green: "#79ffd7",
    orange: "#ffb35c",
    red: "#ff6b6b",
    haze: "rgba(255,255,255,0.08)",
    star: "rgba(255,255,255,0.20)",
    hud: "rgba(255,255,255,0.10)",
    orb: "rgba(255,255,255,0.12)",
    orb2: "rgba(180,180,180,0.10)",
  },
  ...
  zenForest: {
    ...
    name: "Zen Forest",
    skyline:
      "https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?auto=format&fit=crop&w=1800&q=70",
    overlay: "rgba(4,10,7,0.74)",
    glass: "rgba(255,255,255,0.10)",
    glass2: "rgba(255,255,255,0.07)",
    stroke: "rgba(255,255,255,0.18)",
    text: "rgba(255,255,255,0.98)",
    sub: "rgba(255,255,255,0.74)",
    neon: "rgba(120,255,180,0.52)",
    neon2: "rgba(90,210,255,0.24)",
    gold: "#b7ffd0",
    green: "#7bffb2",
    orange: "#ffb35c",
    red: "#ff5d73",
    ...
    star: "rgba(255,255,255,0.20)",
    hud: "rgba(120,255,180,0.12)",
    orb: "rgba(120,255,180,0.16)",
    orb2: "rgba(90,210,255,0.10)",
  },
  ...
  synthArcade: {
    ...
    name: "Synth Arcade",
    skyline:
      "https://images.unsplash.com/photo-1482192596544-9eb780fc7f66?auto=format&fit=crop&w=1800&q=70",
    overlay: "rgba(10,6,18,0.78)",
    glass: "rgba(255,255,255,0.11)",
    glass2: "rgba(255,255,255,0.07)",
    stroke: "rgba(255,255,255,0.18)",
    text: "rgba(255,255,255,0.98)",
    sub: "rgba(255,255,255,0.74)",
    neon: "rgba(255,90,220,0.55)",
    neon2: "rgba(90,210,255,0.38)",
    gold: "#ffb6f0",
    green: "#79ffd7",
    orange: "#ffb35c",
    ...
    haze: "rgba(255,255,255,0.08)",
    star: "rgba(255,255,255,0.22)",
    hud: "rgba(255,90,220,0.12)",
    orb: "rgba(255,90,220,0.18)",
    orb2: "rgba(90,210,255,0.12)",
  },
};
...
// -------------------- Ultra Premium Futuristic Intro (NO deps) --------------------
function DubaiIntro({ onDone, durationMs = 5200 }) {
  ...
  const rot2 = React.useRef(new Animated.Value(0)).current;
  const scanY = React.useRef(new Animated.Value(-H)).current;
  ...
  React.useEffect(() => {
    ...
    // Rotating rings
    Animated.loop(Animated.timing(rot, { toValue: 1, duration: 5200, easing: Easing.linear, useNativeDriver: true })).start();
    Animated.loop(Animated.timing(rot2, { toValue: 1, duration: 7800, easing: Easing.linear, useNativeDriver: true })).start();

    // Scan beam
    Animated.loop(
      Animated.sequence([
        Animated.timing(scanY, { toValue: H, duration: 2000, easing: Easing.inOut(Easing.quad), useNativeDriver: true }),
        Animated.timing(scanY, { toValue: -H, duration: 0, useNativeDriver: true }),
        Animated.delay(450),
      ])
    ).start();

    const t = setTimeout(() => onDone?.(), Math.max(1400, durationMs));
    return () => clearTimeout(t);
  }, [W, H, durationMs, onDone, shimmerX, pulse, rot, rot2, scanY]);

  const glowOpacity = pulse.interpolate({ inputRange: [0, 1], outputRange: [0.25, 0.62] });
  const glowScale = pulse.interpolate({ inputRange: [0, 1], outputRange: [1, 1.04] });
  const ringRot = rot.interpolate({ inputRange: [0, 1], outputRange: ["0deg", "360deg"] });
  const ringRot2 = rot2.interpolate({ inputRange: [0, 1], outputRange: ["360deg", "0deg"] });

  return (
    <Pressable onPress={() => onDone?.()} style={{ flex: 1, backgroundColor: "#05040C" }}>
      <StatusBar hidden />

      {/* Background: layered neon fog */}
      <View style={{ position: "absolute", left: 0, top: 0, right: 0, bottom: 0 }}>
        ...
        <Animated.View
          style={{
            ...
            left: -W * 0.10,
            top: H * 0.52,
            backgroundColor: "#FF2EB8",
            opacity: pulse.interpolate({ inputRange: [0, 1], outputRange: [0.10, 0.28] }),
            transform: [{ scale: glowScale }],
          }}
        />
      ...
      <View style={{ flex: 1, alignItems: "center", justifyContent: "center", paddingHorizontal: 18 }}>
        ...
        <View style={{ position: "absolute", width: W, height: H, alignItems: "center", justifyContent: "center" }}>
          <Animated.View
            pointerEvents="none"
            style={{
              width: Math.min(W * 0.82, 340),
              height: Math.min(W * 0.82, 340),
              borderRadius: 999,
              borderWidth: 1,
          ...
          <Animated.View
            ...
            style={{
              position: "absolute",
              width: Math.min(W * 0.64, 270),
              height: Math.min(W * 0.64, 270),
              borderRadius: 999,
              borderWidth: 1,
          ...
          <Animated.View
            ...
            style={{
              position: "absolute",
              width: Math.min(W * 0.46, 200),
              height: Math.min(W * 0.46, 200),
              borderRadius: 999,
              borderWidth: 1,
              borderColor: "rgba(255,46,184,0.18)",
              transform: [{ rotate: ringRot }],
            }}
          />
        </View>
        ...
        >
          <Text style={{ color: "rgba(255,255,255,0.78)", fontSize: 12, letterSpacing: 3, textAlign: "center" }}>
            Q U A N T U M   B O O T
          </Text>

          {/* subtle glitch-ish layered title */}
          <View style={{ marginTop: 10, alignItems: "center", justifyContent: "center" }}>
            <Text style={{ position: "absolute", color: "rgba(0,229,255,0.45)", fontSize: 32, fontWeight: "900", transform: [{ translateX: -1 }, { translateY: 1 }] }}>
              DrabornEagle
            </Text>
            <Text style={{ position: "absolute", color: "rgba(255,46,184,0.35)", fontSize: 32, fontWeight: "900", transform: [{ translateX: 1 }, { translateY: -1 }] }}>
              DrabornEagle
            </Text>
            <Text style={{ color: "#FFFFFF", fontSize: 32, fontWeight: "900" }}>DrabornEagle</Text>
          </View>

          <Text style={{ color: "rgba(255,255,255,0.70)", fontSize: 13, textAlign: "center", marginTop: 8 }}>
            v6 • Ultra Premium • Secure Save
          </Text>
          ...
          <View style={{ height: 10, borderRadius: 99, backgroundColor: "rgba(255,255,255,0.08)", marginTop: 16, overflow: "hidden" }}>
            <Animated.View
              style={{
                height: 10,
                width: W,
                backgroundColor: "rgba(0,229,255,0.40)",
...
const [tab, setTab] = useState("home");
  ...
  const theme = useMemo(() => THEME_PRESETS[S.themeKey] || THEME_PRESETS.nebulaPrime, [S.themeKey]);
